...
def build_prompt(
    ...
    *,
    ...
    return (
        ...
        "Do not copy natural-language sentences into the formalization.\n"
        "Do not use truth constants such as True or False; express negation "
        "with ¬ and ordinary predicates.\n"
